...
#Finding solution using max() function
max <- max(round_sum, sum_round)
if (round_sum == sum_round) {
  print("They are equal")
} else if (round_sum == max) {
  print("round_sum is bigger")
} else {
  print("sum_round is bigger")
}

#Messing with different solution method
if (sum_round < round_sum) {
  print("round_sum bigger")
} else if (sum_round > round_sum) {
  print("sum_round bigger")
} else {
  print("They are equal")
}

#Attempting another different method 
 if (round_sum == sum_round) {
   print("They are equal")
